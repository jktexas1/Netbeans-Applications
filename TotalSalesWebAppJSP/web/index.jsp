...
<html>
    ...
    <body>
        <h1>Jacob Kapusta C14</h1>
        <h1>COSC 3380 FALL 2014</h1>
        <h1>This is MY work</h1>
        <h1>Will NOT disseminate</h1>
        <h1>Total Sales</h1>
        <%
            Connection connection = DriverManager.getConnection("jdbc:oracle:thin:@//129.7.242.158:1521/ORCL", "jakapust", //
                            "01301992");
